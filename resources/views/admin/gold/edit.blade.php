    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('gold.editGold', ['id' => $gold->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="goods_translate" rows="3"
                                        value="{{ empty(old('goods_translate', $gold->goods_translate )) ? '' : old('goods_translate',  $gold->goods_translate) }}"
                                        placeholder="Enter ...">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" name="date" rows="3"
                                        value="{{ empty(old('date',  $gold->date)) ? '' : old('date',  $gold->date) }}"
                                        placeholder="Enter ...">
                                    @error('date')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="total_stock" rows="3"
                                        value="{{ empty(old('total_stock',  $gold->total_stock)) ? '' : old('total_stock', $gold->total_stock) }}"
                                        placeholder="Enter ...">
                                    @error('total_stock')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="inc_or_dec" rows="3"
                                        value="{{ empty(old('inc_or_dec', $gold->inc_or_dec)) ? '' : old('inc_or_dec', $gold->inc_or_dec) }}"
                                        placeholder="Enter ...">
                                    @error('inc_or_dec')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="total_value" rows="3"
                                        value="{{ empty(old('total_value', $gold->total_value)) ? '' : old('total_value',  $gold->total_value) }}"
                                        placeholder="Enter ...">
                                    @error('total_value')
