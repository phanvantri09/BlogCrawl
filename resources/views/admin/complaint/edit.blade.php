                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="summernote">{{ empty(old('content', $complaint->content)) ? '' : old('content', $complaint->content) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="replenishImg" rows="3" placeholder="Enter ...">{{ empty(old('replenishImg', $complaint->replenishImg)) ? '' : old('replenishImg', $complaint->replenishImg) }}</textarea>
                                    @error('replenishImg')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="replenishContent" rows="3" placeholder="Enter ...">{{ empty(old('replenishContent', $complaint->replenishContent)) ? '' : old('replenishContent', $complaint->replenishContent) }}</textarea>
