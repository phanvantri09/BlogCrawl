                            ...
                            <tbody>
                                @foreach ($data as $key => $complaint)
                                    <tr>
                                        ...
                                        @if ($complaint->img)
                                            <td><img style="max-width: 100%; max-height: 200px;"
                                                    src="{{ asset('storage/images/' . $complaint->img) }}">
                                            </td>
                                        @else
                                            <td></td>
                                        @endif
                                        ...
                                        <td>
                                            <a href="{{ route('complaint.edit', ['id' => $complaint->id]) }}" class="btn btn-app">
                                                <i class="fas fa-edit"></i> Sửa
                                            </a>
                                            <a href="{{ route('complaint.delete', ['id' => $complaint->id]) }}" class="btn btn-app">
