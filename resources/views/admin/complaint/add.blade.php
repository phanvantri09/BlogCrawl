                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <label class="btn btn-primary btn-md btn-file">
                                    Tải ảnh<input name="headImg[]" type="file" accept=".jpg, .png" multiple
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="content"
                                    id="summernote">{{ empty(old('content')) ? '' : old('content') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="replenishImg" rows="3"
                                    placeholder="Enter ...">{{ empty(old('replenishImg')) ? '' : old('replenishImg') }}</textarea>
                                @error('replenishImg')
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="replenishContent" rows="3"
                                    placeholder="Enter ...">{{ empty(old('replenishContent')) ? '' : old('replenishContent') }}</textarea>
...
<script>
    ...
    var imagePreview = $('#' + typeImage + '_preview');
    var imageNames = [];
    ...
    // Lưu tên ảnh
    var imageNamesInput = document.querySelector('input[name="image_names"]');
