...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('broker.editBroker') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="resolutionRate" rows="3"
                                        value="{{ empty(old('resolutionRate', $broker->resolutionRate)) ? '' : old('resolutionRate', $broker->resolutionRate) }}"
                                        placeholder="Enter ...">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="leverMax" rows="3"
                                        value="{{ empty(old('leverMax', $broker->leverMax)) ? '' : old('leverMax', $broker->leverMax) }}"
                                        placeholder="Enter ...">
                                    @error('leverMax')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebookLink" class="form-control" placeholder="Enter ..."
                                        value="{{ old('facebookLink', $broker->facebookLink) }}">
                                    @error('facebookLink')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="licenseName" rows="3"
                                        value="{{ empty(old('licenseName', $broker->licenseName)) ? '' : old('licenseName', $broker->licenseName) }}" placeholder="Enter ...">
                                    @error('licenseName')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="nickname" rows="3"
                                        value="{{ empty(old('nickname',  $broker->nickname)) ? '' : old('nickname', $broker->nickname) }}" placeholder="Enter ...">
                                    @error('money')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="peoples" rows="3"
                                        value="{{ empty(old('peoples',  $broker->peoples)) ? '' : old('peoples',  $broker->peoples) }}" placeholder="Enter ...">
                                    @error('peoples')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="skypeLink" rows="3"
                                        value="{{ empty(old('skypeLink', $broker->skypeLink)) ? '' : old('skypeLink', $broker->skypeLink) }}" placeholder="Enter ...">
                                    @error('skypeLink')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="telegramLink" rows="3"
                                        value="{{ empty(old('telegramLink', $broker->telegramLink)) ? '' : old('telegramLink',$broker->telegramLink) }}" placeholder="Enter ...">
                                    @error('telegramLink')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="twitterLink" rows="3"
                                        value="{{ empty(old('twitterLink', $broker->twitterLink)) ? '' : old('twitterLink', $broker->twitterLink) }}" placeholder="Enter ...">
                                    @error('twitterLink')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="website" rows="3"
                                        value="{{ empty(old('website', $broker->website)) ? '' : old('website',  $broker->website) }}" placeholder="Enter ...">
                                    @error('website')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="youtubeLink" rows="3"
                                        value="{{ empty(old('youtubeLink', $broker->youtubeLink)) ? '' : old('youtubeLink', $broker->youtubeLink) }}" placeholder="Enter ...">
                                    @error('youtubeLink')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="zaloLink" rows="3"
                                        value="{{ empty(old('zaloLink', $broker->zaloLink)) ? '' : old('zaloLink', $broker->zaloLink) }}" placeholder="Enter ...">
                                    @error('zaloLink')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="summernote">{{ empty(old('content', $broker->content)) ? '' : old('content', $broker->content) }}</textarea>
                                </div>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="platformLicenseList" rows="3" placeholder="Enter ...">{{ empty(old('platformLicenseList', $broker->platformLicenseList)) ? '' : old('platformLicenseList', $broker->platformLicenseList) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="lookImgList" rows="3" placeholder="Enter ...">{{ empty(old('lookImgList', $broker->lookImgList)) ? '' : old('lookImgList', $broker->lookImgList) }}</textarea>
                                    @error('lookImgList')
    ...
    <script>
        $(document).ready(function() {
            ...
            });//set limit for maximum input field
