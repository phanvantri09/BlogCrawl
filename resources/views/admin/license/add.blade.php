    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('license.addLicense') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <img id="countryLogo_preview" style="max-width: 100%; max-height: 200px;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <img id="licenseLogo_preview" style="max-width: 100%; max-height: 200px;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="regulatoryEffectiveTime" class="form-control" placeholder="Enter ..."
                                        value="{{ old('regulatoryEffectiveTime') }}">
