        ...
        @foreach ($posts as $key => $post)
            @if ($post->content)
                ...
                @if ($key == $rand - 2)
                                ...
                                <div class="slider-box-item mx-1 mb-2">
                                    <div class="image">
                                        <a href="{{ $broker->facebookLink ?? ' ' }}">
                                            @if ($broker->img)
                                                <img src="{{ App\Helpers\ConstCommon::getLinkIMG($broker->img) }}"
                                                    alt="">
                                            @endif
                                        </a>
                                    </div>
                                    <div class="slider-box-item-content px-2 py-3">
                                        <div class="title">
                                            ...
                                            @if ($broker->firstCountryLogo)
                                                <img src="{{ App\Helpers\ConstCommon::getLinkIMG($broker->firstCountryLogo) }}"
                                                    alt="">
                                            @endif &nbsp;
                                        ...
                                        <div class="box">
                                            ...
                                            <span
                                                class="text-red font-weight-bold">{{ $broker->resolutionRate ?? ' ' }}</span>
                                        </div>
                    ...
                    <div class="slider-short-video-card py-3 px-2">
