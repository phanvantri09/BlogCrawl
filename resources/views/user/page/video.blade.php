    ...
    <div class="main-content-container px-3 pt-2">
        <div class="video-item">
            <div class="video-view-container">
                <a href="">
                    <div class="video-box">
                        <iframe src="https://www.youtube.com/embed/fTDv68llRcg?si=elHTiOCeetMets5_"
                    ...
                    <div class="video-info p-3">
                        ...
                        <div class="video-info-title">NGUYÊN NHÂN VÀNG TĂNG MẠNH BẤT CHẤP CHỈ SỐ DXY | AD</div>
                    </div>
                </a>
            </div>
        ...
        <div class="video-item">
            <div class="video-view-container">
                <div class="video-box">
                    <iframe src="https://www.youtube.com/embed/fTDv68llRcg?si=elHTiOCeetMets5_" title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        allowfullscreen></iframe>
                </div>
